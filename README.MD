...
performs time series classification with an unsupervised convolutional neural network (CNN) trained using contrastive learning 
followed by a support vector classifier (SVC). 
